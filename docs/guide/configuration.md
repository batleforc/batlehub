...
> For a step-by-step publishing walkthrough, see [`docs/guide/publishing.md § Cargo`](publishing.md#4-cargo).
...
> For a step-by-step publishing walkthrough, see [`docs/guide/publishing.md § npm`](publishing.md#3-npm).
...
> For a step-by-step publishing walkthrough, see [`docs/guide/publishing.md § VS Code Extensions`](publishing.md#5-vs-code-extensions-openvsx--vs-code-marketplace).
...
> For a step-by-step publishing walkthrough, see [`docs/guide/publishing.md § Go Modules`](publishing.md#6-go-modules).
