---
title: Package Explorer — cache & API — moved
moved: /use/package-explorer-cache
head:
  - - meta
    - http-equiv: refresh
      content: 0; url=/use/package-explorer-cache
---

# This page moved

**Package Explorer — cache & API** now lives at [/use/package-explorer-cache](/use/package-explorer-cache).
