...
const config = withMermaid(defineConfig({
  ...
  //
  // Only a numbered RFC carries one. `rfc/index.md` and `rfc/grading.md` are
  // about the RFCs — a listing and a review — and neither has a status of its
  // own to quote, so they are recognised by the same filename rule
      ...
      "/rfc/": [
        {
          ...
          items: [
            ...
            { text: "Grading and order", link: "/rfc/grading" },
