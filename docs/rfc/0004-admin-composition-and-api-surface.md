...
Rows R12–R16 were not questions this RFC opened; they are things the work turned up, recorded
here per the rule below rather than settled silently in a commit message.
