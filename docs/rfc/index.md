...
Of the 21 below, fourteen are implemented, one is accepted, one is in review,
four are drafts and one is superseded.
...
| [0017 — Grants editor](/rfc/0017-writing-grants-at-the-package-and-version-tiers) | Draft | Who writes a package- or version-tier grant, and what §4.4 filters once they exist |
...
3. **[0014](/rfc/0014-upstream-disappearance) phases 1–3 and 5** — detection
...
4. **[0002](/rfc/0002-vulnerability-flags-and-exposure) — vulnerability flags
...
5. **[0008](/rfc/0008-mise-in-an-air-gapped-estate) — the air gap.** After
...
6. **[0011](/rfc/0011-openvsx-login) — authenticated OpenVSX.** Last: the most
