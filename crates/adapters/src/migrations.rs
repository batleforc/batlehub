...
pub fn embedded_migrator() -> Migrator {
    Migrator {
        migrations: Cow::Owned(vec![
            ...
            mig!(11, "package ownership",     "../migrations/011_package_ownership.sql"),
            ...
            mig!(15, "team namespaces",       "../migrations/015_team_namespaces.sql"),
            mig!(16, "package visibility",    "../migrations/016_package_visibility.sql"),
        ]),
